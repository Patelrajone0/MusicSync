  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-3 sm:px-4 py-4 sm:py-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="relative bg-dark-900/85 backdrop-blur-2xl border border-white/10 hover:border-cyan-400/30 rounded-3xl p-4 sm:p-6 md:p-7 shadow-[0_0_50px_rgba(0,0,0,0.8),0_0_25px_rgba(0,240,255,0.06)] space-y-4 sm:space-y-6 transition-all duration-300 w-full max-w-full overflow-hidden box-border">
          ...
          {/* Action 2: Join Existing Room (Responsive auto-fitting layout) */}
          <form onSubmit={handleJoinRoom} className="space-y-3 w-full">
